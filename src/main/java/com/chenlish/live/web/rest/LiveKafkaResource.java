...
@RestController
@RequestMapping("/api/live-kafka")
public class LiveKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LiveKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LiveKafkaResource(KafkaProperties kafkaProperties) {
